  ...
  try{
    ...
    if(req.method==="GET"){
      ...
      if(u.searchParams.get("run")==="1"){
        if(who.as!=="automation"&&who.as!=="service")return json({error:"nur_automatik",hint:"Ein Pruflauf mit Alarmierung wird ausschliesslich vom Zeitplan ausgeloest."},403);
