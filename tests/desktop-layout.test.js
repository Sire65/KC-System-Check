...
test('desktop layout is wired into startup and Pages bundle',()=>{const state=read('js/startup-modules.js'),pages=read('.github/workflows/pages.yml');assert.match(state,/desktop-layout\.js/);assert.match(pages,/desktop-layout\.js/)});
