...
test('health assistant is wired through application state module',()=>{const s=fs.readFileSync('js/startup-modules.js','utf8');assert.match(s,/import"\.\/health-assistant\.js"/)});
